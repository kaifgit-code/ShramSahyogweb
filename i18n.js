// EN/HI dictionary for UI strings.
const I18N = {
  en: {
    ...
    "find.urgent": "This is urgent (search all cities)",
    ...
    "register.kycTitle": "🛡️ Worker verification (KYC)",
    "register.kycStatus": "Aadhaar KYC status",
    "register.certificate": "Trade / skill certificate ID (optional)",
    "register.kycNote": "Prototype only — real Aadhaar/KYC checks would run through an authorised verification provider.",
    ...
    "support.sub": "Facing an issue with a booking or a worker? Raise it here.",
    "support.phone": "Your phone number",
    "support.type": "Issue type",
    "support.desc": "Describe the issue",
    "support.submit": "Submit complaint",
    "support.listTitle": "Your complaints",
    ...
    "admin.complaintsTitle": "Complaints",
  ...
  hi: {
    ...
    "find.urgent": "यह अत्यावश्यक है (सभी शहरों में खोजें)",
    ...
    "register.kycTitle": "🛡️ कामगार सत्यापन (KYC)",
    "register.kycStatus": "आधार KYC स्थिति",
    "register.certificate": "ट्रेड / स्किल सर्टिफिकेट आईडी (वैकल्पिक)",
    "register.kycNote": "केवल प्रोटोटाइप — असली आधार/KYC जांच अधिकृत सत्यापन प्रदाता से होगी।",
    ...
    "support.title": "सहायता और शिकायत",
    "support.sub": "बुकिंग या कामगार से जुड़ी समस्या है? यहां दर्ज करें।",
    "support.phone": "आपका फ़ोन नंबर",
    "support.type": "समस्या का प्रकार",
    "support.desc": "समस्या बताएं",
    "support.submit": "शिकायत दर्ज करें",
    "support.listTitle": "आपकी शिकायतें",
    ...
    "admin.complaintsTitle": "शिकायतें",
